...
const sketch = ({ canvas, width, height }) => {
  ...
  imgBContext.width = imgA.width;
  imgBContext.height = imgA.height;
  ...
  for (let i = 0; i < numCircles; i++) {
    ...
    let ix, iy, r, g, b, colA, colB, colMap;
...
const start = async () => {
  imgA = await loadImage("images/rachel-cook.jpg");
  imgB = await loadImage("images/unsplash-ballon.jpg");
...
class Particle {
  constructor({ x, y, radius = 10, colMap }) {
    ...
    this.pullFactor = random.range(0.002, 0.0006);
